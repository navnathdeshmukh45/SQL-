create database  engineering0;
use engineering0;
create table engineering0(
...
insert into engineering0 (rollno,id,name,mark,grade,city)
values
...
select *from engineering0;
--  find the avg mark of engineering0
select avg(mark)
from engineering0;
-- find the  percentage  find the student in tables.
select mark,name
from engineering0
where mark > 70.00 ;
